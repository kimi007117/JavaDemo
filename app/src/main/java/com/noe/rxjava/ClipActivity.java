...
public class ClipActivity extends AppCompatActivity {
    ...
    private ListView mListViewClip;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mListViewClip = (ListView) findViewById(R.id.listView_clip);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(ClipActivity.this, android.R.layout.simple_list_item_1, arrayList);
        mListViewClip.setAdapter(arrayAdapter);
    }
    ...
    protected void onStart() {
        ...
        super.onStart();
        // -----------location config ------------
        mLocationService = ((RxApplication) getApplication()).locationService;
        ...
        startLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (startLocation.getText().toString().equals("START")) {
