...
public class XRecyclerView extends RecyclerView {
    ...
    private void init(Context context) {
        mContext = context;
        View h = inflate(mContext, R.layout.header_recycler_pull, null);
        if (pullRefreshEnabled) {
            XRecyclerViewHeader xRecyclerViewHeader = new XRecyclerViewHeader(mContext);
            mHeaderViews.add(0, h);
            mHeaderViews.add(1, xRecyclerViewHeader);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.i("getTop-->",String.valueOf(screenLocation[1]));
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_REFRESH_HEADER) {
                return new SimpleViewHolder(mHeaderViews.get(1));
