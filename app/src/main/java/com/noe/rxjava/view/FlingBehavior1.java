...
/**
 * Created by lijie on 2019-08-08.
 */
public class FlingBehavior1 extends AppBarLayout.Behavior {
    ...
    public FlingBehavior1(){}
    public FlingBehavior1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
