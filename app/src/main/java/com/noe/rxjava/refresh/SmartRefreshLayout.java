package com.noe.rxjava.refresh;
...
import com.noe.rxjava.refresh.api.DefaultRefreshFooterCreator;
import com.noe.rxjava.refresh.api.DefaultRefreshHeaderCreator;
import com.noe.rxjava.refresh.api.DefaultRefreshInitializer;
import com.noe.rxjava.refresh.api.RefreshContent;
import com.noe.rxjava.refresh.api.RefreshFooter;
import com.noe.rxjava.refresh.api.RefreshHeader;
import com.noe.rxjava.refresh.api.RefreshInternal;
import com.noe.rxjava.refresh.api.RefreshKernel;
import com.noe.rxjava.refresh.api.RefreshLayout;
import com.noe.rxjava.refresh.api.ScrollBoundaryDecider;
import com.noe.rxjava.refresh.constant.DimensionStatus;
import com.noe.rxjava.refresh.constant.RefreshState;
import com.noe.rxjava.refresh.constant.SpinnerStyle;
import com.noe.rxjava.refresh.footer.ClassicsFooter;
import com.noe.rxjava.refresh.header.ClassicsHeader;
import com.noe.rxjava.refresh.impl.RefreshContentWrapper;
import com.noe.rxjava.refresh.impl.RefreshFooterWrapper;
import com.noe.rxjava.refresh.impl.RefreshHeaderWrapper;
import com.noe.rxjava.refresh.listener.OnLoadMoreListener;
import com.noe.rxjava.refresh.listener.OnMultiPurposeListener;
import com.noe.rxjava.refresh.listener.OnRefreshListener;
import com.noe.rxjava.refresh.listener.OnRefreshLoadMoreListener;
import com.noe.rxjava.refresh.listener.OnStateChangedListener;
import com.noe.rxjava.refresh.util.SmartUtil;
...
import static com.noe.rxjava.refresh.util.SmartUtil.dp2px;
import static com.noe.rxjava.refresh.util.SmartUtil.fling;
import static com.noe.rxjava.refresh.util.SmartUtil.isContentView;
...
//    }
     ...
     * Recommended {@link com.noe.rxjava.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.noe.rxjava.refresh.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.noe.rxjava.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.noe.rxjava.refresh.impl.ScrollBoundaryDeciderAdapter}
...
//                        resetStatus();
    ...
    //</editor-fold>
        ...
        /**
         * 移动滚动 Scroll
         * moveSpinner 的取名来自 谷歌官方的 {@link SwipeRefreshLayout#moveSpinner(float)}
         * moveSpinner The name comes from {@link SwipeRefreshLayout#moveSpinner(float)}
