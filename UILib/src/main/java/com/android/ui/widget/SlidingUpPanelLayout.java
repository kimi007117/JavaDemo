...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default is set to true for show fade.
     */
    private static final boolean DEFAULT_SHOW_FADE = true;
     ...
     * The fade will show.
     */
    private boolean mShowFade = DEFAULT_SHOW_FADE;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mShowFade = ta.getBoolean(R.styleable.SlidingUpPanelLayout_umanoShowFade, DEFAULT_SHOW_FADE);
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mSlideableView != null && mSlideableView != child) { // if main view
            ...
            if (mShowFade && mCoveredFadeColor != 0 && mSlideOffset > 0) {
